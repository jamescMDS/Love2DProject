...
function whitePlayerData.Construct()

  whitePlayerData.runAnimationFile = '2 Owlet_Monster/Owlet_Monster_Run_6.png'
  whitePlayerData.runAttackAnimationFile = '2 Owlet_Monster/Owlet_Monster_Walk+Attack_6.png'
